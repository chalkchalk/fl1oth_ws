...
static void InitDefaultsscc_info_ParaStaticLayer_static_5flayer_5fsetting_2eproto() {
  ...
  {
    void* ptr = &::f1tenth_costmap::_ParaStaticLayer_default_instance_;
    new (ptr) ::f1tenth_costmap::ParaStaticLayer();
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_static_5flayer_5fsetting_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  PROTOBUF_FIELD_OFFSET(::f1tenth_costmap::ParaStaticLayer, _has_bits_),
  PROTOBUF_FIELD_OFFSET(::f1tenth_costmap::ParaStaticLayer, _internal_metadata_),
  ~0u,  // no _extensions_
  ~0u,  // no _oneof_case_
  ~0u,  // no _weak_field_map_
  PROTOBUF_FIELD_OFFSET(::f1tenth_costmap::ParaStaticLayer, first_map_only_),
  PROTOBUF_FIELD_OFFSET(::f1tenth_costmap::ParaStaticLayer, subscribe_to_updates_),
  PROTOBUF_FIELD_OFFSET(::f1tenth_costmap::ParaStaticLayer, track_unknown_space_),
  PROTOBUF_FIELD_OFFSET(::f1tenth_costmap::ParaStaticLayer, use_maximum_),
  PROTOBUF_FIELD_OFFSET(::f1tenth_costmap::ParaStaticLayer, unknown_cost_value_),
  PROTOBUF_FIELD_OFFSET(::f1tenth_costmap::ParaStaticLayer, trinary_map_),
  PROTOBUF_FIELD_OFFSET(::f1tenth_costmap::ParaStaticLayer, lethal_threshold_),
  PROTOBUF_FIELD_OFFSET(::f1tenth_costmap::ParaStaticLayer, topic_name_),
  PROTOBUF_FIELD_OFFSET(::f1tenth_costmap::ParaStaticLayer, is_raw_rosmessage_),
  PROTOBUF_FIELD_OFFSET(::f1tenth_costmap::ParaStaticLayer, is_debug_),
  1,
  2,
  3,
  4,
...
static const ::PROTOBUF_NAMESPACE_ID::internal::MigrationSchema schemas[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  { 0, 15, sizeof(::f1tenth_costmap::ParaStaticLayer)},
};

static ::PROTOBUF_NAMESPACE_ID::Message const * const file_default_instances[] = {
  reinterpret_cast<const ::PROTOBUF_NAMESPACE_ID::Message*>(&::f1tenth_costmap::_ParaStaticLayer_default_instance_),
};

const char descriptor_table_protodef_static_5flayer_5fsetting_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\032static_layer_setting.proto\022\017f1tenth_co"
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_static_5flayer_5fsetting_2eproto = {
  false, false, descriptor_table_protodef_static_5flayer_5fsetting_2eproto, "static_layer_setting.proto", 309,
...
ParaStaticLayer::ParaStaticLayer(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  // @@protoc_insertion_point(arena_constructor:f1tenth_costmap.ParaStaticLayer)
}
ParaStaticLayer::ParaStaticLayer(const ParaStaticLayer& from)
  ...
  // @@protoc_insertion_point(copy_constructor:f1tenth_costmap.ParaStaticLayer)
}
...
ParaStaticLayer::~ParaStaticLayer() {
  // @@protoc_insertion_point(destructor:f1tenth_costmap.ParaStaticLayer)
  SharedDtor();
...
// @@protoc_insertion_point(message_clear_start:f1tenth_costmap.ParaStaticLayer)
    ...
    switch (tag >> 3) {
      ...
      case 8:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 66)) {
          ...
          #ifndef NDEBUG
          ::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "f1tenth_costmap.ParaStaticLayer.topic_name");
          #endif  // !NDEBUG
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* ParaStaticLayer::_InternalSerialize(
  ...
  // @@protoc_insertion_point(serialize_to_array_start:f1tenth_costmap.ParaStaticLayer)
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
  ...
  if (cached_has_bits & 0x00000001u) {
    ::PROTOBUF_NAMESPACE_ID::internal::WireFormat::VerifyUTF8StringNamedField(
      ...
      "f1tenth_costmap.ParaStaticLayer.topic_name");
  ...
  // @@protoc_insertion_point(serialize_to_array_end:f1tenth_costmap.ParaStaticLayer)
  return target;
}

size_t ParaStaticLayer::RequiredFieldsByteSizeFallback() const {
// @@protoc_insertion_point(required_fields_byte_size_fallback_start:f1tenth_costmap.ParaStaticLayer)
  size_t total_size = 0;
...
// @@protoc_insertion_point(message_byte_size_start:f1tenth_costmap.ParaStaticLayer)
  size_t total_size = 0;
...
// @@protoc_insertion_point(generalized_merge_from_start:f1tenth_costmap.ParaStaticLayer)
  GOOGLE_DCHECK_NE(&from, this);
  const ParaStaticLayer* source =
      ::PROTOBUF_NAMESPACE_ID::DynamicCastToGenerated<ParaStaticLayer>(
          &from);
  if (source == nullptr) {
  // @@protoc_insertion_point(generalized_merge_from_cast_fail:f1tenth_costmap.ParaStaticLayer)
    ::PROTOBUF_NAMESPACE_ID::internal::ReflectionOps::Merge(from, this);
  } else {
  // @@protoc_insertion_point(generalized_merge_from_cast_success:f1tenth_costmap.ParaStaticLayer)
    MergeFrom(*source);
  }
}

void ParaStaticLayer::MergeFrom(const ParaStaticLayer& from) {
// @@protoc_insertion_point(class_specific_merge_from_start:f1tenth_costmap.ParaStaticLayer)
  GOOGLE_DCHECK_NE(&from, this);
  _internal_metadata_.MergeFrom<::PROTOBUF_NAMESPACE_ID::UnknownFieldSet>(from._internal_metadata_);
  ::PROTOBUF_NAMESPACE_ID::uint32 cached_has_bits = 0;
  (void) cached_has_bits;
...
// @@protoc_insertion_point(generalized_copy_from_start:f1tenth_costmap.ParaStaticLayer)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
// @@protoc_insertion_point(class_specific_copy_from_start:f1tenth_costmap.ParaStaticLayer)
  if (&from == this) return;
  Clear();
  MergeFrom(from);
}
...
template<> PROTOBUF_NOINLINE ::f1tenth_costmap::ParaStaticLayer* Arena::CreateMaybeMessage< ::f1tenth_costmap::ParaStaticLayer >(Arena* arena) {
  return Arena::CreateMessageInternal< ::f1tenth_costmap::ParaStaticLayer >(arena);
}
