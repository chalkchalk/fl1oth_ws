...
#ifndef F1TENTH_PLANNING_LOCAL_PLANNER_ROBOT_POSITION_COST_H
#define F1TENTH_PLANNING_LOCAL_PLANNER_ROBOT_POSITION_COST_H
...
class RobotPositionCost {
 public:
   ...
   */
  RobotPositionCost(const f1tenth_costmap::Costmap2D& cost_map);
  /**
   * @brief Destructor
   */
  ~RobotPositionCost();
 ...
 private:
  //! Cost map
  const f1tenth_costmap::Costmap2D& costmap_;
};
...
#endif //F1TENTH_PLANNING_LOCAL_PLANNER_ROBOT_POSITION_COST_H
