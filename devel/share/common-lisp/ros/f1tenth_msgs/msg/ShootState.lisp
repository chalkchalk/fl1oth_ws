...
(cl:defmethod cl:initialize-instance :after ((m <ShootState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ShootState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenth_msgs-msg:<ShootState> is deprecated: use f1tenth_msgs-msg:ShootState instead.")))

(cl:ensure-generic-function 'single_shoot-val :lambda-list '(m))
(cl:defmethod single_shoot-val ((m <ShootState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-msg:single_shoot-val is deprecated.  Use f1tenth_msgs-msg:single_shoot instead.")
  (single_shoot m))

(cl:ensure-generic-function 'continue_shoot-val :lambda-list '(m))
(cl:defmethod continue_shoot-val ((m <ShootState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-msg:continue_shoot-val is deprecated.  Use f1tenth_msgs-msg:continue_shoot instead.")
  (continue_shoot m))

(cl:ensure-generic-function 'run_friction_whell-val :lambda-list '(m))
(cl:defmethod run_friction_whell-val ((m <ShootState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-msg:run_friction_whell-val is deprecated.  Use f1tenth_msgs-msg:run_friction_whell instead.")
...
(cl:defmethod friction_whell_speed-val ((m <ShootState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-msg:friction_whell_speed-val is deprecated.  Use f1tenth_msgs-msg:friction_whell_speed instead.")
