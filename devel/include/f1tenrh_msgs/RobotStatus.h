// Generated by gencpp from file f1tenrh_msgs/RobotStatus.msg
// DO NOT EDIT!


#ifndef F1TENRH_MSGS_MESSAGE_ROBOTSTATUS_H
#define F1TENRH_MSGS_MESSAGE_ROBOTSTATUS_H
...
struct RobotStatus_
{
  ...
  typedef boost::shared_ptr< ::f1tenrh_msgs::RobotStatus_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::f1tenrh_msgs::RobotStatus_<ContainerAllocator> const> ConstPtr;

}; // struct RobotStatus_

typedef ::f1tenrh_msgs::RobotStatus_<std::allocator<void> > RobotStatus;

typedef boost::shared_ptr< ::f1tenrh_msgs::RobotStatus > RobotStatusPtr;
typedef boost::shared_ptr< ::f1tenrh_msgs::RobotStatus const> RobotStatusConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::f1tenrh_msgs::RobotStatus_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::f1tenrh_msgs::RobotStatus_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::f1tenrh_msgs::RobotStatus_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::f1tenrh_msgs::RobotStatus_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::f1tenrh_msgs::RobotStatus_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::f1tenrh_msgs::RobotStatus_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::f1tenrh_msgs::RobotStatus_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::f1tenrh_msgs::RobotStatus_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::f1tenrh_msgs::RobotStatus_<ContainerAllocator> >
{
  ...
  static const char* value(const ::f1tenrh_msgs::RobotStatus_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x122334534857c129ULL;
  static const uint64_t static_value2 = 0x4574d2c7eef57af5ULL;
};

template<class ContainerAllocator>
struct DataType< ::f1tenrh_msgs::RobotStatus_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::f1tenrh_msgs::RobotStatus_<ContainerAllocator> >
{
  static const char* value()
  {
    return "#robot status\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::f1tenrh_msgs::RobotStatus_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::f1tenrh_msgs::RobotStatus_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::f1tenrh_msgs::RobotStatus_<ContainerAllocator>& v)
  {
    s << indent << "id: ";
...
#endif // F1TENRH_MSGS_MESSAGE_ROBOTSTATUS_H
