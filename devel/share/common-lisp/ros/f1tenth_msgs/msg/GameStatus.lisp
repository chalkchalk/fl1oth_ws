...
(cl:defmethod cl:initialize-instance :after ((m <GameStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GameStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenth_msgs-msg:<GameStatus> is deprecated: use f1tenth_msgs-msg:GameStatus instead.")))

(cl:ensure-generic-function 'game_status-val :lambda-list '(m))
(cl:defmethod game_status-val ((m <GameStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-msg:game_status-val is deprecated.  Use f1tenth_msgs-msg:game_status instead.")
  (game_status m))

(cl:ensure-generic-function 'remaining_time-val :lambda-list '(m))
(cl:defmethod remaining_time-val ((m <GameStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-msg:remaining_time-val is deprecated.  Use f1tenth_msgs-msg:remaining_time instead.")
  (remaining_time m))
