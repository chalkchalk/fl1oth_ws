...
PROTOBUF_NAMESPACE_OPEN
template<> ::f1tenth_costmap::ParaStaticLayer* Arena::CreateMaybeMessage<::f1tenth_costmap::ParaStaticLayer>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace f1tenth_costmap {
...
class ParaStaticLayer PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:f1tenth_costmap.ParaStaticLayer) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "f1tenth_costmap.ParaStaticLayer";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:f1tenth_costmap.ParaStaticLayer)
 private:
  class _Internal;
...
inline bool ParaStaticLayer::first_map_only() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaStaticLayer.first_map_only)
...
inline void ParaStaticLayer::set_first_map_only(bool value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaStaticLayer.first_map_only)
}
...
inline bool ParaStaticLayer::subscribe_to_updates() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaStaticLayer.subscribe_to_updates)
...
inline void ParaStaticLayer::set_subscribe_to_updates(bool value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaStaticLayer.subscribe_to_updates)
}
...
inline bool ParaStaticLayer::track_unknown_space() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaStaticLayer.track_unknown_space)
...
inline void ParaStaticLayer::set_track_unknown_space(bool value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaStaticLayer.track_unknown_space)
}
...
inline bool ParaStaticLayer::use_maximum() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaStaticLayer.use_maximum)
...
inline void ParaStaticLayer::set_use_maximum(bool value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaStaticLayer.use_maximum)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 ParaStaticLayer::unknown_cost_value() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaStaticLayer.unknown_cost_value)
...
inline void ParaStaticLayer::set_unknown_cost_value(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaStaticLayer.unknown_cost_value)
}
...
inline bool ParaStaticLayer::trinary_map() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaStaticLayer.trinary_map)
...
inline void ParaStaticLayer::set_trinary_map(bool value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaStaticLayer.trinary_map)
}
...
inline ::PROTOBUF_NAMESPACE_ID::int32 ParaStaticLayer::lethal_threshold() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaStaticLayer.lethal_threshold)
...
inline void ParaStaticLayer::set_lethal_threshold(::PROTOBUF_NAMESPACE_ID::int32 value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaStaticLayer.lethal_threshold)
}
...
inline const std::string& ParaStaticLayer::topic_name() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaStaticLayer.topic_name)
...
inline void ParaStaticLayer::set_topic_name(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaStaticLayer.topic_name)
}
inline std::string* ParaStaticLayer::mutable_topic_name() {
  // @@protoc_insertion_point(field_mutable:f1tenth_costmap.ParaStaticLayer.topic_name)
...
inline void ParaStaticLayer::set_topic_name(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:f1tenth_costmap.ParaStaticLayer.topic_name)
}
inline void ParaStaticLayer::set_topic_name(const char* value) {
  ...
  topic_name_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:f1tenth_costmap.ParaStaticLayer.topic_name)
}
inline void ParaStaticLayer::set_topic_name(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  ...
  // @@protoc_insertion_point(field_set_pointer:f1tenth_costmap.ParaStaticLayer.topic_name)
}
...
inline std::string* ParaStaticLayer::release_topic_name() {
  // @@protoc_insertion_point(field_release:f1tenth_costmap.ParaStaticLayer.topic_name)
...
inline void ParaStaticLayer::set_allocated_topic_name(std::string* topic_name) {
  ...
  topic_name_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), topic_name,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:f1tenth_costmap.ParaStaticLayer.topic_name)
}
...
inline bool ParaStaticLayer::is_raw_rosmessage() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaStaticLayer.is_raw_rosmessage)
...
inline void ParaStaticLayer::set_is_raw_rosmessage(bool value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaStaticLayer.is_raw_rosmessage)
}
...
inline bool ParaStaticLayer::is_debug() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaStaticLayer.is_debug)
...
inline void ParaStaticLayer::set_is_debug(bool value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaStaticLayer.is_debug)
}
