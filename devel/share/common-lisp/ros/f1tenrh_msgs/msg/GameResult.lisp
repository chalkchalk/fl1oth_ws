...
(cl:defmethod cl:initialize-instance :after ((m <GameResult>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GameResult)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenrh_msgs-msg:<GameResult> is deprecated: use f1tenrh_msgs-msg:GameResult instead.")))

(cl:ensure-generic-function 'result-val :lambda-list '(m))
(cl:defmethod result-val ((m <GameResult>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:result-val is deprecated.  Use f1tenrh_msgs-msg:result instead.")
  (result m))
