...
(cl:defmethod cl:initialize-instance :after ((m <GlobalPlannerFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GlobalPlannerFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenrh_msgs-msg:<GlobalPlannerFeedback> is deprecated: use f1tenrh_msgs-msg:GlobalPlannerFeedback instead.")))

(cl:ensure-generic-function 'path-val :lambda-list '(m))
(cl:defmethod path-val ((m <GlobalPlannerFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:path-val is deprecated.  Use f1tenrh_msgs-msg:path instead.")
  (path m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<GlobalPlannerFeedback>)))
  ...
  "f1tenrh_msgs/GlobalPlannerFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'GlobalPlannerFeedback)))
  "Returns string type for a message object of type 'GlobalPlannerFeedback"
  "f1tenrh_msgs/GlobalPlannerFeedback")
