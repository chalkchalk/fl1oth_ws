...
(cl:defmethod cl:initialize-instance :after ((m <RobotBonus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotBonus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenrh_msgs-msg:<RobotBonus> is deprecated: use f1tenrh_msgs-msg:RobotBonus instead.")))

(cl:ensure-generic-function 'bonus-val :lambda-list '(m))
(cl:defmethod bonus-val ((m <RobotBonus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:bonus-val is deprecated.  Use f1tenrh_msgs-msg:bonus instead.")
  (bonus m))
