...
PROTOBUF_NAMESPACE_OPEN
template<> ::f1tenth_costmap::Footprint* Arena::CreateMaybeMessage<::f1tenth_costmap::Footprint>(Arena*);
template<> ::f1tenth_costmap::ParaBasic* Arena::CreateMaybeMessage<::f1tenth_costmap::ParaBasic>(Arena*);
template<> ::f1tenth_costmap::ParaCollection* Arena::CreateMaybeMessage<::f1tenth_costmap::ParaCollection>(Arena*);
template<> ::f1tenth_costmap::ParaCostmapInterface* Arena::CreateMaybeMessage<::f1tenth_costmap::ParaCostmapInterface>(Arena*);
template<> ::f1tenth_costmap::Point* Arena::CreateMaybeMessage<::f1tenth_costmap::Point>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace f1tenth_costmap {
...
class ParaBasic PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:f1tenth_costmap.ParaBasic) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "f1tenth_costmap.ParaBasic";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:f1tenth_costmap.ParaBasic)
 private:
  class _Internal;
...
class ParaCostmapInterface PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:f1tenth_costmap.ParaCostmapInterface) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "f1tenth_costmap.ParaCostmapInterface";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:f1tenth_costmap.ParaCostmapInterface)
 private:
  class _Internal;
...
class Point PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:f1tenth_costmap.Point) */ {
 public:
  ...
  // @@protoc_insertion_point(class_scope:f1tenth_costmap.Point)
 private:
  class _Internal;
...
class Footprint PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:f1tenth_costmap.Footprint) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "f1tenth_costmap.Footprint";
  }
  protected:
  ...
  public:
  void clear_point();
  ::f1tenth_costmap::Point* mutable_point(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::f1tenth_costmap::Point >*
      mutable_point();
  private:
  const ::f1tenth_costmap::Point& _internal_point(int index) const;
  ::f1tenth_costmap::Point* _internal_add_point();
  public:
  const ::f1tenth_costmap::Point& point(int index) const;
  ::f1tenth_costmap::Point* add_point();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::f1tenth_costmap::Point >&
      point() const;

  // @@protoc_insertion_point(class_scope:f1tenth_costmap.Footprint)
 private:
  class _Internal;
  ...
  typedef void InternalArenaConstructable_;
  typedef void DestructorSkippable_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::f1tenth_costmap::Point > point_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  friend struct ::TableStruct_costmap_5fparameter_5fsetting_2eproto;
};
// -------------------------------------------------------------------
...
class ParaCollection PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:f1tenth_costmap.ParaCollection) */ {
 public:
  ...
  friend class ::PROTOBUF_NAMESPACE_ID::internal::AnyMetadata;
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "f1tenth_costmap.ParaCollection";
  }
  protected:
  ...
  const ::f1tenth_costmap::ParaCostmapInterface& para_costmap_interface() const;
  ::f1tenth_costmap::ParaCostmapInterface* release_para_costmap_interface();
  ::f1tenth_costmap::ParaCostmapInterface* mutable_para_costmap_interface();
  void set_allocated_para_costmap_interface(::f1tenth_costmap::ParaCostmapInterface* para_costmap_interface);
  private:
  const ::f1tenth_costmap::ParaCostmapInterface& _internal_para_costmap_interface() const;
  ::f1tenth_costmap::ParaCostmapInterface* _internal_mutable_para_costmap_interface();
  public:
  void unsafe_arena_set_allocated_para_costmap_interface(
      ::f1tenth_costmap::ParaCostmapInterface* para_costmap_interface);
  ::f1tenth_costmap::ParaCostmapInterface* unsafe_arena_release_para_costmap_interface();
  ...
  const ::f1tenth_costmap::Footprint& footprint() const;
  ::f1tenth_costmap::Footprint* release_footprint();
  ::f1tenth_costmap::Footprint* mutable_footprint();
  void set_allocated_footprint(::f1tenth_costmap::Footprint* footprint);
  private:
  const ::f1tenth_costmap::Footprint& _internal_footprint() const;
  ::f1tenth_costmap::Footprint* _internal_mutable_footprint();
  public:
  void unsafe_arena_set_allocated_footprint(
      ::f1tenth_costmap::Footprint* footprint);
  ::f1tenth_costmap::Footprint* unsafe_arena_release_footprint();
  ...
  const ::f1tenth_costmap::ParaBasic& para_basic() const;
  ::f1tenth_costmap::ParaBasic* release_para_basic();
  ::f1tenth_costmap::ParaBasic* mutable_para_basic();
  void set_allocated_para_basic(::f1tenth_costmap::ParaBasic* para_basic);
  private:
  const ::f1tenth_costmap::ParaBasic& _internal_para_basic() const;
  ::f1tenth_costmap::ParaBasic* _internal_mutable_para_basic();
  public:
  void unsafe_arena_set_allocated_para_basic(
      ::f1tenth_costmap::ParaBasic* para_basic);
  ::f1tenth_costmap::ParaBasic* unsafe_arena_release_para_basic();

  // @@protoc_insertion_point(class_scope:f1tenth_costmap.ParaCollection)
 private:
  class _Internal;
  ...
  ::PROTOBUF_NAMESPACE_ID::internal::HasBits<1> _has_bits_;
  mutable ::PROTOBUF_NAMESPACE_ID::internal::CachedSize _cached_size_;
  ::f1tenth_costmap::ParaCostmapInterface* para_costmap_interface_;
  ::f1tenth_costmap::Footprint* footprint_;
  ::f1tenth_costmap::ParaBasic* para_basic_;
  friend struct ::TableStruct_costmap_5fparameter_5fsetting_2eproto;
};
// ===================================================================
...
inline bool ParaBasic::is_raw_rosmessage() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaBasic.is_raw_rosmessage)
...
inline void ParaBasic::set_is_raw_rosmessage(bool value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaBasic.is_raw_rosmessage)
}
...
inline bool ParaBasic::is_debug() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaBasic.is_debug)
...
inline void ParaBasic::set_is_debug(bool value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaBasic.is_debug)
}
...
inline const std::string& ParaCostmapInterface::global_frame() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaCostmapInterface.global_frame)
...
inline void ParaCostmapInterface::set_global_frame(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaCostmapInterface.global_frame)
}
inline std::string* ParaCostmapInterface::mutable_global_frame() {
  // @@protoc_insertion_point(field_mutable:f1tenth_costmap.ParaCostmapInterface.global_frame)
...
inline void ParaCostmapInterface::set_global_frame(std::string&& value) {
  ...
  // @@protoc_insertion_point(field_set_rvalue:f1tenth_costmap.ParaCostmapInterface.global_frame)
}
inline void ParaCostmapInterface::set_global_frame(const char* value) {
  ...
  global_frame_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:f1tenth_costmap.ParaCostmapInterface.global_frame)
}
inline void ParaCostmapInterface::set_global_frame(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000001u;
  ...
  // @@protoc_insertion_point(field_set_pointer:f1tenth_costmap.ParaCostmapInterface.global_frame)
}
...
inline std::string* ParaCostmapInterface::release_global_frame() {
  // @@protoc_insertion_point(field_release:f1tenth_costmap.ParaCostmapInterface.global_frame)
...
inline void ParaCostmapInterface::set_allocated_global_frame(std::string* global_frame) {
  ...
  global_frame_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), global_frame,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:f1tenth_costmap.ParaCostmapInterface.global_frame)
}
...
inline const std::string& ParaCostmapInterface::robot_base_frame() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaCostmapInterface.robot_base_frame)
...
inline void ParaCostmapInterface::set_robot_base_frame(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaCostmapInterface.robot_base_frame)
}
inline std::string* ParaCostmapInterface::mutable_robot_base_frame() {
  // @@protoc_insertion_point(field_mutable:f1tenth_costmap.ParaCostmapInterface.robot_base_frame)
...
inline void ParaCostmapInterface::set_robot_base_frame(std::string&& value) {
  ...
  robot_base_frame_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:f1tenth_costmap.ParaCostmapInterface.robot_base_frame)
}
inline void ParaCostmapInterface::set_robot_base_frame(const char* value) {
  ...
  robot_base_frame_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:f1tenth_costmap.ParaCostmapInterface.robot_base_frame)
}
inline void ParaCostmapInterface::set_robot_base_frame(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000002u;
  robot_base_frame_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:f1tenth_costmap.ParaCostmapInterface.robot_base_frame)
}
...
inline std::string* ParaCostmapInterface::release_robot_base_frame() {
  // @@protoc_insertion_point(field_release:f1tenth_costmap.ParaCostmapInterface.robot_base_frame)
...
inline void ParaCostmapInterface::set_allocated_robot_base_frame(std::string* robot_base_frame) {
  ...
  robot_base_frame_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), robot_base_frame,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:f1tenth_costmap.ParaCostmapInterface.robot_base_frame)
}
...
inline double ParaCostmapInterface::footprint_padding() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaCostmapInterface.footprint_padding)
...
inline void ParaCostmapInterface::set_footprint_padding(double value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaCostmapInterface.footprint_padding)
}
...
inline double ParaCostmapInterface::transform_tolerance() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaCostmapInterface.transform_tolerance)
...
inline void ParaCostmapInterface::set_transform_tolerance(double value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaCostmapInterface.transform_tolerance)
}
...
inline double ParaCostmapInterface::distance_threshold() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaCostmapInterface.distance_threshold)
...
inline void ParaCostmapInterface::set_distance_threshold(double value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaCostmapInterface.distance_threshold)
}
...
inline double ParaCostmapInterface::map_width() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaCostmapInterface.map_width)
...
inline void ParaCostmapInterface::set_map_width(double value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaCostmapInterface.map_width)
}
...
inline double ParaCostmapInterface::map_height() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaCostmapInterface.map_height)
...
inline void ParaCostmapInterface::set_map_height(double value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaCostmapInterface.map_height)
}
...
inline double ParaCostmapInterface::map_origin_x() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaCostmapInterface.map_origin_x)
...
inline void ParaCostmapInterface::set_map_origin_x(double value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaCostmapInterface.map_origin_x)
}
...
inline double ParaCostmapInterface::map_origin_y() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaCostmapInterface.map_origin_y)
...
inline void ParaCostmapInterface::set_map_origin_y(double value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaCostmapInterface.map_origin_y)
}
...
inline double ParaCostmapInterface::map_resolution() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaCostmapInterface.map_resolution)
...
inline void ParaCostmapInterface::set_map_resolution(double value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaCostmapInterface.map_resolution)
}
...
inline bool ParaCostmapInterface::is_tracking_unknown() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaCostmapInterface.is_tracking_unknown)
...
inline void ParaCostmapInterface::set_is_tracking_unknown(bool value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaCostmapInterface.is_tracking_unknown)
}
...
inline bool ParaCostmapInterface::is_rolling_window() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaCostmapInterface.is_rolling_window)
...
inline void ParaCostmapInterface::set_is_rolling_window(bool value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaCostmapInterface.is_rolling_window)
}
...
inline bool ParaCostmapInterface::has_obstacle_layer() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaCostmapInterface.has_obstacle_layer)
...
inline void ParaCostmapInterface::set_has_obstacle_layer(bool value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaCostmapInterface.has_obstacle_layer)
}
...
inline bool ParaCostmapInterface::has_static_layer() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaCostmapInterface.has_static_layer)
...
inline void ParaCostmapInterface::set_has_static_layer(bool value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaCostmapInterface.has_static_layer)
}
...
inline const std::string& ParaCostmapInterface::inflation_file_path() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaCostmapInterface.inflation_file_path)
...
inline void ParaCostmapInterface::set_inflation_file_path(const std::string& value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaCostmapInterface.inflation_file_path)
}
inline std::string* ParaCostmapInterface::mutable_inflation_file_path() {
  // @@protoc_insertion_point(field_mutable:f1tenth_costmap.ParaCostmapInterface.inflation_file_path)
...
inline void ParaCostmapInterface::set_inflation_file_path(std::string&& value) {
  ...
  inflation_file_path_.Set(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value), GetArena());
  // @@protoc_insertion_point(field_set_rvalue:f1tenth_costmap.ParaCostmapInterface.inflation_file_path)
}
inline void ParaCostmapInterface::set_inflation_file_path(const char* value) {
  ...
  inflation_file_path_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value),
              GetArena());
  // @@protoc_insertion_point(field_set_char:f1tenth_costmap.ParaCostmapInterface.inflation_file_path)
}
inline void ParaCostmapInterface::set_inflation_file_path(const char* value,
    size_t size) {
  _has_bits_[0] |= 0x00000004u;
  inflation_file_path_.Set(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(
      reinterpret_cast<const char*>(value), size), GetArena());
  // @@protoc_insertion_point(field_set_pointer:f1tenth_costmap.ParaCostmapInterface.inflation_file_path)
}
...
inline std::string* ParaCostmapInterface::release_inflation_file_path() {
  // @@protoc_insertion_point(field_release:f1tenth_costmap.ParaCostmapInterface.inflation_file_path)
...
inline void ParaCostmapInterface::set_allocated_inflation_file_path(std::string* inflation_file_path) {
  ...
  inflation_file_path_.SetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), inflation_file_path,
      GetArena());
  // @@protoc_insertion_point(field_set_allocated:f1tenth_costmap.ParaCostmapInterface.inflation_file_path)
}
...
inline double ParaCostmapInterface::map_update_frequency() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaCostmapInterface.map_update_frequency)
...
inline void ParaCostmapInterface::set_map_update_frequency(double value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaCostmapInterface.map_update_frequency)
}
...
inline double Point::x() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.Point.x)
  return _internal_x();
}
...
inline void Point::set_x(double value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.Point.x)
}
...
inline double Point::y() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.Point.y)
  return _internal_y();
}
...
inline void Point::set_y(double value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.Point.y)
}
...
inline ::f1tenth_costmap::Point* Footprint::mutable_point(int index) {
  // @@protoc_insertion_point(field_mutable:f1tenth_costmap.Footprint.point)
  return point_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::f1tenth_costmap::Point >*
Footprint::mutable_point() {
  // @@protoc_insertion_point(field_mutable_list:f1tenth_costmap.Footprint.point)
  return &point_;
}
inline const ::f1tenth_costmap::Point& Footprint::_internal_point(int index) const {
  return point_.Get(index);
}
inline const ::f1tenth_costmap::Point& Footprint::point(int index) const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.Footprint.point)
  return _internal_point(index);
}
inline ::f1tenth_costmap::Point* Footprint::_internal_add_point() {
  return point_.Add();
}
inline ::f1tenth_costmap::Point* Footprint::add_point() {
  // @@protoc_insertion_point(field_add:f1tenth_costmap.Footprint.point)
  return _internal_add_point();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::f1tenth_costmap::Point >&
Footprint::point() const {
  // @@protoc_insertion_point(field_list:f1tenth_costmap.Footprint.point)
  return point_;
}
...
inline const ::f1tenth_costmap::ParaCostmapInterface& ParaCollection::_internal_para_costmap_interface() const {
  const ::f1tenth_costmap::ParaCostmapInterface* p = para_costmap_interface_;
  return p != nullptr ? *p : reinterpret_cast<const ::f1tenth_costmap::ParaCostmapInterface&>(
      ::f1tenth_costmap::_ParaCostmapInterface_default_instance_);
}
inline const ::f1tenth_costmap::ParaCostmapInterface& ParaCollection::para_costmap_interface() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaCollection.para_costmap_interface)
...
inline void ParaCollection::unsafe_arena_set_allocated_para_costmap_interface(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:f1tenth_costmap.ParaCollection.para_costmap_interface)
}
inline ::f1tenth_costmap::ParaCostmapInterface* ParaCollection::release_para_costmap_interface() {
  _has_bits_[0] &= ~0x00000001u;
  ::f1tenth_costmap::ParaCostmapInterface* temp = para_costmap_interface_;
...
inline ::f1tenth_costmap::ParaCostmapInterface* ParaCollection::unsafe_arena_release_para_costmap_interface() {
  // @@protoc_insertion_point(field_release:f1tenth_costmap.ParaCollection.para_costmap_interface)
  _has_bits_[0] &= ~0x00000001u;
  ::f1tenth_costmap::ParaCostmapInterface* temp = para_costmap_interface_;
  para_costmap_interface_ = nullptr;
  return temp;
}
inline ::f1tenth_costmap::ParaCostmapInterface* ParaCollection::_internal_mutable_para_costmap_interface() {
  _has_bits_[0] |= 0x00000001u;
  if (para_costmap_interface_ == nullptr) {
    auto* p = CreateMaybeMessage<::f1tenth_costmap::ParaCostmapInterface>(GetArena());
    para_costmap_interface_ = p;
  }
  return para_costmap_interface_;
}
inline ::f1tenth_costmap::ParaCostmapInterface* ParaCollection::mutable_para_costmap_interface() {
  // @@protoc_insertion_point(field_mutable:f1tenth_costmap.ParaCollection.para_costmap_interface)
  return _internal_mutable_para_costmap_interface();
}
inline void ParaCollection::set_allocated_para_costmap_interface(::f1tenth_costmap::ParaCostmapInterface* para_costmap_interface) {
  ...
  para_costmap_interface_ = para_costmap_interface;
  // @@protoc_insertion_point(field_set_allocated:f1tenth_costmap.ParaCollection.para_costmap_interface)
}
...
inline const ::f1tenth_costmap::Footprint& ParaCollection::_internal_footprint() const {
  const ::f1tenth_costmap::Footprint* p = footprint_;
  return p != nullptr ? *p : reinterpret_cast<const ::f1tenth_costmap::Footprint&>(
      ::f1tenth_costmap::_Footprint_default_instance_);
}
inline const ::f1tenth_costmap::Footprint& ParaCollection::footprint() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaCollection.footprint)
...
inline void ParaCollection::unsafe_arena_set_allocated_footprint(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:f1tenth_costmap.ParaCollection.footprint)
}
inline ::f1tenth_costmap::Footprint* ParaCollection::release_footprint() {
  _has_bits_[0] &= ~0x00000002u;
  ::f1tenth_costmap::Footprint* temp = footprint_;
  footprint_ = nullptr;
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
...
inline ::f1tenth_costmap::Footprint* ParaCollection::unsafe_arena_release_footprint() {
  // @@protoc_insertion_point(field_release:f1tenth_costmap.ParaCollection.footprint)
  _has_bits_[0] &= ~0x00000002u;
  ::f1tenth_costmap::Footprint* temp = footprint_;
  footprint_ = nullptr;
  return temp;
}
inline ::f1tenth_costmap::Footprint* ParaCollection::_internal_mutable_footprint() {
  _has_bits_[0] |= 0x00000002u;
  if (footprint_ == nullptr) {
    auto* p = CreateMaybeMessage<::f1tenth_costmap::Footprint>(GetArena());
    footprint_ = p;
  }
  return footprint_;
}
inline ::f1tenth_costmap::Footprint* ParaCollection::mutable_footprint() {
  // @@protoc_insertion_point(field_mutable:f1tenth_costmap.ParaCollection.footprint)
  return _internal_mutable_footprint();
}
inline void ParaCollection::set_allocated_footprint(::f1tenth_costmap::Footprint* footprint) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete footprint_;
  }
  ...
  footprint_ = footprint;
  // @@protoc_insertion_point(field_set_allocated:f1tenth_costmap.ParaCollection.footprint)
}
...
inline const ::f1tenth_costmap::ParaBasic& ParaCollection::_internal_para_basic() const {
  const ::f1tenth_costmap::ParaBasic* p = para_basic_;
  return p != nullptr ? *p : reinterpret_cast<const ::f1tenth_costmap::ParaBasic&>(
      ::f1tenth_costmap::_ParaBasic_default_instance_);
}
inline const ::f1tenth_costmap::ParaBasic& ParaCollection::para_basic() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaCollection.para_basic)
...
inline void ParaCollection::unsafe_arena_set_allocated_para_basic(
  ...
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:f1tenth_costmap.ParaCollection.para_basic)
}
inline ::f1tenth_costmap::ParaBasic* ParaCollection::release_para_basic() {
  _has_bits_[0] &= ~0x00000004u;
  ::f1tenth_costmap::ParaBasic* temp = para_basic_;
  para_basic_ = nullptr;
  if (GetArena() != nullptr) {
    temp = ::PROTOBUF_NAMESPACE_ID::internal::DuplicateIfNonNull(temp);
  }
...
inline ::f1tenth_costmap::ParaBasic* ParaCollection::unsafe_arena_release_para_basic() {
  // @@protoc_insertion_point(field_release:f1tenth_costmap.ParaCollection.para_basic)
  _has_bits_[0] &= ~0x00000004u;
  ::f1tenth_costmap::ParaBasic* temp = para_basic_;
  para_basic_ = nullptr;
  return temp;
}
inline ::f1tenth_costmap::ParaBasic* ParaCollection::_internal_mutable_para_basic() {
  _has_bits_[0] |= 0x00000004u;
  if (para_basic_ == nullptr) {
    auto* p = CreateMaybeMessage<::f1tenth_costmap::ParaBasic>(GetArena());
    para_basic_ = p;
  }
  return para_basic_;
}
inline ::f1tenth_costmap::ParaBasic* ParaCollection::mutable_para_basic() {
  // @@protoc_insertion_point(field_mutable:f1tenth_costmap.ParaCollection.para_basic)
  return _internal_mutable_para_basic();
}
inline void ParaCollection::set_allocated_para_basic(::f1tenth_costmap::ParaBasic* para_basic) {
  ::PROTOBUF_NAMESPACE_ID::Arena* message_arena = GetArena();
  if (message_arena == nullptr) {
    delete para_basic_;
  }
  ...
  para_basic_ = para_basic;
  // @@protoc_insertion_point(field_set_allocated:f1tenth_costmap.ParaCollection.para_basic)
}
