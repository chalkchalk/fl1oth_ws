...
(cl:defmethod cl:initialize-instance :after ((m <SupplierStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'SupplierStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenth_msgs-msg:<SupplierStatus> is deprecated: use f1tenth_msgs-msg:SupplierStatus instead.")))

(cl:ensure-generic-function 'status-val :lambda-list '(m))
(cl:defmethod status-val ((m <SupplierStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-msg:status-val is deprecated.  Use f1tenth_msgs-msg:status instead.")
  (status m))
