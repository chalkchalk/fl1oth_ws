 ...
 ***************************************************************************/
#ifndef F1TENTH_PLANNING_GLOBAL_PLANNER_GLOBAL_PLANNER_NODE_H
#define F1TENTH_PLANNING_GLOBAL_PLANNER_GLOBAL_PLANNER_NODE_H
...
class GlobalPlannerNode {
 public:
  typedef std::shared_ptr<f1tenth_costmap::CostmapInterface> CostmapPtr;
  typedef std::shared_ptr<tf::TransformListener> TfPtr;
  typedef std::unique_ptr<GlobalPlannerBase> GlobalPlannerPtr;
  typedef actionlib::SimpleActionServer<f1tenth_msgs::GlobalPlannerAction> GlobalPlannerServer;
 /**
 ...
 private:
   ...
   */
  void GoalCallback(const f1tenth_msgs::GlobalPlannerGoal::ConstPtr &msg);
  /**
   * @brief Set the state for planning module
   * @param node_state Enumerate State for global planning
   */
  void SetNodeState(f1tenth_common::NodeState node_state);
  /**
   ...
   */
  void SetErrorInfo(f1tenth_common::ErrorInfo error_info);
  /**
  ...
  f1tenth_common::ErrorInfo error_info_;
...
#endif //F1TENTH_PLANNING_GLOBAL_PLANNER_GLOBAL_PLANNER_NODE_H
