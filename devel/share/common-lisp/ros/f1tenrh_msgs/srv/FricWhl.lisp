...
(cl:defmethod cl:initialize-instance :after ((m <FricWhl-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FricWhl-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenrh_msgs-srv:<FricWhl-request> is deprecated: use f1tenrh_msgs-srv:FricWhl-request instead.")))

(cl:ensure-generic-function 'open-val :lambda-list '(m))
(cl:defmethod open-val ((m <FricWhl-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-srv:open-val is deprecated.  Use f1tenrh_msgs-srv:open instead.")
  (open m))
...
(cl:defmethod cl:initialize-instance :after ((m <FricWhl-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'FricWhl-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenrh_msgs-srv:<FricWhl-response> is deprecated: use f1tenrh_msgs-srv:FricWhl-response instead.")))
