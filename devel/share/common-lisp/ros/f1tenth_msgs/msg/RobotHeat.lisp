...
(cl:defmethod cl:initialize-instance :after ((m <RobotHeat>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotHeat)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenth_msgs-msg:<RobotHeat> is deprecated: use f1tenth_msgs-msg:RobotHeat instead.")))

(cl:ensure-generic-function 'chassis_volt-val :lambda-list '(m))
(cl:defmethod chassis_volt-val ((m <RobotHeat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-msg:chassis_volt-val is deprecated.  Use f1tenth_msgs-msg:chassis_volt instead.")
  (chassis_volt m))

(cl:ensure-generic-function 'chassis_current-val :lambda-list '(m))
(cl:defmethod chassis_current-val ((m <RobotHeat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-msg:chassis_current-val is deprecated.  Use f1tenth_msgs-msg:chassis_current instead.")
  (chassis_current m))

(cl:ensure-generic-function 'chassis_power-val :lambda-list '(m))
(cl:defmethod chassis_power-val ((m <RobotHeat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-msg:chassis_power-val is deprecated.  Use f1tenth_msgs-msg:chassis_power instead.")
  (chassis_power m))

(cl:ensure-generic-function 'chassis_power_buffer-val :lambda-list '(m))
(cl:defmethod chassis_power_buffer-val ((m <RobotHeat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-msg:chassis_power_buffer-val is deprecated.  Use f1tenth_msgs-msg:chassis_power_buffer instead.")
  (chassis_power_buffer m))

(cl:ensure-generic-function 'shooter_heat-val :lambda-list '(m))
(cl:defmethod shooter_heat-val ((m <RobotHeat>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-msg:shooter_heat-val is deprecated.  Use f1tenth_msgs-msg:shooter_heat instead.")
  (shooter_heat m))
