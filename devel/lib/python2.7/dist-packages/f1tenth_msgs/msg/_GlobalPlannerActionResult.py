...
"""autogenerated by genpy from f1tenth_msgs/GlobalPlannerActionResult.msg. Do not edit."""
import sys
...
class GlobalPlannerActionResult(genpy.Message):
  ...
  _type = "f1tenth_msgs/GlobalPlannerActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','f1tenth_msgs/GlobalPlannerResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = f1tenth_msgs.msg.GlobalPlannerResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = f1tenth_msgs.msg.GlobalPlannerResult()
