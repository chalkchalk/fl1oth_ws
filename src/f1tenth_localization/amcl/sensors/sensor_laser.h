...
#ifndef F1TENTH_LOCALIZATION_AMCL_SENSORS_SENSOR_LASER_H
#define F1TENTH_LOCALIZATION_AMCL_SENSORS_SENSOR_LASER_H
...
#endif //F1TENTH_LOCALIZATION_AMCL_SENSORS_SENSOR_LASER_H
