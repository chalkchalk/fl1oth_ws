// Generated by gencpp from file f1tenth_msgs/ObstacleMsg.msg
// DO NOT EDIT!


#ifndef F1TENTH_MSGS_MESSAGE_OBSTACLEMSG_H
#define F1TENTH_MSGS_MESSAGE_OBSTACLEMSG_H
...
struct ObstacleMsg_
{
  ...
  typedef boost::shared_ptr< ::f1tenth_msgs::ObstacleMsg_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::f1tenth_msgs::ObstacleMsg_<ContainerAllocator> const> ConstPtr;

}; // struct ObstacleMsg_

typedef ::f1tenth_msgs::ObstacleMsg_<std::allocator<void> > ObstacleMsg;

typedef boost::shared_ptr< ::f1tenth_msgs::ObstacleMsg > ObstacleMsgPtr;
typedef boost::shared_ptr< ::f1tenth_msgs::ObstacleMsg const> ObstacleMsgConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::f1tenth_msgs::ObstacleMsg_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::f1tenth_msgs::ObstacleMsg_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::f1tenth_msgs::ObstacleMsg_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::f1tenth_msgs::ObstacleMsg_<ContainerAllocator> const>
  : FalseType
  { };

template <class ContainerAllocator>
struct IsMessage< ::f1tenth_msgs::ObstacleMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::f1tenth_msgs::ObstacleMsg_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::f1tenth_msgs::ObstacleMsg_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::f1tenth_msgs::ObstacleMsg_<ContainerAllocator> const>
  : TrueType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::f1tenth_msgs::ObstacleMsg_<ContainerAllocator> >
{
  ...
  static const char* value(const ::f1tenth_msgs::ObstacleMsg_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0xa537b0b7fce70da7ULL;
  static const uint64_t static_value2 = 0xb78c2df042f56aa2ULL;
};

template<class ContainerAllocator>
struct DataType< ::f1tenth_msgs::ObstacleMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
template<class ContainerAllocator>
struct Definition< ::f1tenth_msgs::ObstacleMsg_<ContainerAllocator> >
{
  static const char* value()
  {
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::f1tenth_msgs::ObstacleMsg_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::f1tenth_msgs::ObstacleMsg_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::f1tenth_msgs::ObstacleMsg_<ContainerAllocator>& v)
  {
    s << indent << "header: ";
    s << std::endl;
...
#endif // F1TENTH_MSGS_MESSAGE_OBSTACLEMSG_H
