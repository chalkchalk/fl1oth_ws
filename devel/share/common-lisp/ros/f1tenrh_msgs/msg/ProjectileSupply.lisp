...
(cl:defmethod cl:initialize-instance :after ((m <ProjectileSupply>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ProjectileSupply)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenrh_msgs-msg:<ProjectileSupply> is deprecated: use f1tenrh_msgs-msg:ProjectileSupply instead.")))

(cl:ensure-generic-function 'number-val :lambda-list '(m))
(cl:defmethod number-val ((m <ProjectileSupply>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:number-val is deprecated.  Use f1tenrh_msgs-msg:number instead.")
  (number m))
