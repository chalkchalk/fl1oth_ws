...
(cl:in-package f1tenth_msgs-srv)
...
(cl:defmethod cl:initialize-instance :after ((m <ShootCmd-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ShootCmd-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenth_msgs-srv:<ShootCmd-request> is deprecated: use f1tenth_msgs-srv:ShootCmd-request instead.")))

(cl:ensure-generic-function 'mode-val :lambda-list '(m))
(cl:defmethod mode-val ((m <ShootCmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-srv:mode-val is deprecated.  Use f1tenth_msgs-srv:mode instead.")
  (mode m))

(cl:ensure-generic-function 'number-val :lambda-list '(m))
(cl:defmethod number-val ((m <ShootCmd-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-srv:number-val is deprecated.  Use f1tenth_msgs-srv:number instead.")
  (number m))
...
(cl:defmethod cl:initialize-instance :after ((m <ShootCmd-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ShootCmd-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenth_msgs-srv:<ShootCmd-response> is deprecated: use f1tenth_msgs-srv:ShootCmd-response instead.")))

(cl:ensure-generic-function 'received-val :lambda-list '(m))
(cl:defmethod received-val ((m <ShootCmd-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-srv:received-val is deprecated.  Use f1tenth_msgs-srv:received instead.")
  (received m))
