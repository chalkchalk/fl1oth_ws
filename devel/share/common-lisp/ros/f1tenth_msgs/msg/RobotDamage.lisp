...
(cl:defmethod cl:initialize-instance :after ((m <RobotDamage>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotDamage)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenth_msgs-msg:<RobotDamage> is deprecated: use f1tenth_msgs-msg:RobotDamage instead.")))

(cl:ensure-generic-function 'damage_type-val :lambda-list '(m))
(cl:defmethod damage_type-val ((m <RobotDamage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-msg:damage_type-val is deprecated.  Use f1tenth_msgs-msg:damage_type instead.")
  (damage_type m))

(cl:ensure-generic-function 'damage_source-val :lambda-list '(m))
(cl:defmethod damage_source-val ((m <RobotDamage>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-msg:damage_source-val is deprecated.  Use f1tenth_msgs-msg:damage_source instead.")
  (damage_source m))
