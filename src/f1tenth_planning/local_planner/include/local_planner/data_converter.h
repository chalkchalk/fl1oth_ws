...
#ifndef F1TENTH_PLANNING_LOCAL_PLANNER_DATA_CONVERTER_H_
#define F1TENTH_PLANNING_LOCAL_PLANNER_DATA_CONVERTER_H_
...
class DataConverter {
 public:
  /**
   * @brief Convert f1tenth_costmap::RobotPose to std::pair<Eigen::Vector2d, double>
   * @param pose Data structure of f1tenth_costmap::RobotPose
   * @return Data structure of std::pair<Eigen::Vector2d, double>
   */
  static std::pair<Eigen::Vector2d, double> LocalConvertRMData(const f1tenth_costmap::RobotPose &pose) {
...
#endif //F1TENTH_PLANNING_LOCAL_PLANNER_DATA_CONVERTER_H_
