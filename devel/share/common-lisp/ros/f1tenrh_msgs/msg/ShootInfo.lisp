...
(cl:defmethod cl:initialize-instance :after ((m <ShootInfo>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ShootInfo)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenrh_msgs-msg:<ShootInfo> is deprecated: use f1tenrh_msgs-msg:ShootInfo instead.")))
...
(cl:defmethod remain_bullet-val ((m <ShootInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:remain_bullet-val is deprecated.  Use f1tenrh_msgs-msg:remain_bullet instead.")
  (remain_bullet m))

(cl:ensure-generic-function 'sent_bullet-val :lambda-list '(m))
(cl:defmethod sent_bullet-val ((m <ShootInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:sent_bullet-val is deprecated.  Use f1tenrh_msgs-msg:sent_bullet instead.")
  (sent_bullet m))

(cl:ensure-generic-function 'fric_wheel_run-val :lambda-list '(m))
(cl:defmethod fric_wheel_run-val ((m <ShootInfo>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:fric_wheel_run-val is deprecated.  Use f1tenrh_msgs-msg:fric_wheel_run instead.")
  (fric_wheel_run m))
