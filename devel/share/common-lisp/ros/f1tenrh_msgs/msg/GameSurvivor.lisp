...
(cl:defmethod cl:initialize-instance :after ((m <GameSurvivor>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GameSurvivor)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenrh_msgs-msg:<GameSurvivor> is deprecated: use f1tenrh_msgs-msg:GameSurvivor instead.")))

(cl:ensure-generic-function 'red3-val :lambda-list '(m))
(cl:defmethod red3-val ((m <GameSurvivor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:red3-val is deprecated.  Use f1tenrh_msgs-msg:red3 instead.")
  (red3 m))

(cl:ensure-generic-function 'red4-val :lambda-list '(m))
(cl:defmethod red4-val ((m <GameSurvivor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:red4-val is deprecated.  Use f1tenrh_msgs-msg:red4 instead.")
  (red4 m))

(cl:ensure-generic-function 'blue3-val :lambda-list '(m))
(cl:defmethod blue3-val ((m <GameSurvivor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:blue3-val is deprecated.  Use f1tenrh_msgs-msg:blue3 instead.")
  (blue3 m))

(cl:ensure-generic-function 'blue4-val :lambda-list '(m))
(cl:defmethod blue4-val ((m <GameSurvivor>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:blue4-val is deprecated.  Use f1tenrh_msgs-msg:blue4 instead.")
  (blue4 m))
