...
(cl:defmethod cl:initialize-instance :after ((m <RobotStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenrh_msgs-msg:<RobotStatus> is deprecated: use f1tenrh_msgs-msg:RobotStatus instead.")))

(cl:ensure-generic-function 'id-val :lambda-list '(m))
(cl:defmethod id-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:id-val is deprecated.  Use f1tenrh_msgs-msg:id instead.")
  (id m))

(cl:ensure-generic-function 'level-val :lambda-list '(m))
(cl:defmethod level-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:level-val is deprecated.  Use f1tenrh_msgs-msg:level instead.")
  (level m))

(cl:ensure-generic-function 'remain_hp-val :lambda-list '(m))
(cl:defmethod remain_hp-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:remain_hp-val is deprecated.  Use f1tenrh_msgs-msg:remain_hp instead.")
  (remain_hp m))

(cl:ensure-generic-function 'max_hp-val :lambda-list '(m))
(cl:defmethod max_hp-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:max_hp-val is deprecated.  Use f1tenrh_msgs-msg:max_hp instead.")
  (max_hp m))

(cl:ensure-generic-function 'heat_cooling_limit-val :lambda-list '(m))
(cl:defmethod heat_cooling_limit-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:heat_cooling_limit-val is deprecated.  Use f1tenrh_msgs-msg:heat_cooling_limit instead.")
...
(cl:defmethod heat_cooling_rate-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:heat_cooling_rate-val is deprecated.  Use f1tenrh_msgs-msg:heat_cooling_rate instead.")
  (heat_cooling_rate m))

(cl:ensure-generic-function 'gimbal_output-val :lambda-list '(m))
(cl:defmethod gimbal_output-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:gimbal_output-val is deprecated.  Use f1tenrh_msgs-msg:gimbal_output instead.")
  (gimbal_output m))

(cl:ensure-generic-function 'chassis_output-val :lambda-list '(m))
(cl:defmethod chassis_output-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:chassis_output-val is deprecated.  Use f1tenrh_msgs-msg:chassis_output instead.")
  (chassis_output m))

(cl:ensure-generic-function 'shooter_output-val :lambda-list '(m))
(cl:defmethod shooter_output-val ((m <RobotStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:shooter_output-val is deprecated.  Use f1tenrh_msgs-msg:shooter_output instead.")
  (shooter_output m))
