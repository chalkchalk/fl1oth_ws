...
(cl:defmethod cl:initialize-instance :after ((m <BonusStatus>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BonusStatus)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenrh_msgs-msg:<BonusStatus> is deprecated: use f1tenrh_msgs-msg:BonusStatus instead.")))

(cl:ensure-generic-function 'red_bonus-val :lambda-list '(m))
(cl:defmethod red_bonus-val ((m <BonusStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:red_bonus-val is deprecated.  Use f1tenrh_msgs-msg:red_bonus instead.")
  (red_bonus m))

(cl:ensure-generic-function 'blue_bonus-val :lambda-list '(m))
(cl:defmethod blue_bonus-val ((m <BonusStatus>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:blue_bonus-val is deprecated.  Use f1tenrh_msgs-msg:blue_bonus instead.")
  (blue_bonus m))
