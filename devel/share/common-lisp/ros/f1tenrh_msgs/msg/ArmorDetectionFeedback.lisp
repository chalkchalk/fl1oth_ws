...
(cl:defmethod cl:initialize-instance :after ((m <ArmorDetectionFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ArmorDetectionFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenrh_msgs-msg:<ArmorDetectionFeedback> is deprecated: use f1tenrh_msgs-msg:ArmorDetectionFeedback instead.")))

(cl:ensure-generic-function 'detected-val :lambda-list '(m))
(cl:defmethod detected-val ((m <ArmorDetectionFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:detected-val is deprecated.  Use f1tenrh_msgs-msg:detected instead.")
  (detected m))
...
(cl:defmethod enemy_pos-val ((m <ArmorDetectionFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:enemy_pos-val is deprecated.  Use f1tenrh_msgs-msg:enemy_pos instead.")
  (enemy_pos m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ArmorDetectionFeedback>)))
  ...
  "f1tenrh_msgs/ArmorDetectionFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ArmorDetectionFeedback)))
  "Returns string type for a message object of type 'ArmorDetectionFeedback"
  "f1tenrh_msgs/ArmorDetectionFeedback")
