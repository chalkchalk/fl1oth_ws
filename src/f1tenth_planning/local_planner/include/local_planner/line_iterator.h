...
#ifndef F1TENTH_PLANNING_LOCAL_PLANNER_LINE_ITERATOR_H
#define F1TENTH_PLANNING_LOCAL_PLANNER_LINE_ITERATOR_H
...
#endif //F1TENTH_PLANNING_LOCAL_PLANNER_LINE_ITERATOR_H
