...
PROTOBUF_NAMESPACE_OPEN
template<> ::f1tenth_costmap::ParaInflationLayer* Arena::CreateMaybeMessage<::f1tenth_costmap::ParaInflationLayer>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace f1tenth_costmap {
...
class ParaInflationLayer PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:f1tenth_costmap.ParaInflationLayer) */ {
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "f1tenth_costmap.ParaInflationLayer";
  }
  protected:
  ...
  // @@protoc_insertion_point(class_scope:f1tenth_costmap.ParaInflationLayer)
 private:
  class _Internal;
...
inline double ParaInflationLayer::inflation_radius() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaInflationLayer.inflation_radius)
...
inline void ParaInflationLayer::set_inflation_radius(double value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaInflationLayer.inflation_radius)
}
...
inline double ParaInflationLayer::cost_scaling_factor() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaInflationLayer.cost_scaling_factor)
...
inline void ParaInflationLayer::set_cost_scaling_factor(double value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaInflationLayer.cost_scaling_factor)
}
...
inline bool ParaInflationLayer::is_debug() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaInflationLayer.is_debug)
...
inline void ParaInflationLayer::set_is_debug(bool value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaInflationLayer.is_debug)
}
...
inline bool ParaInflationLayer::is_raw_rosmessage() const {
  // @@protoc_insertion_point(field_get:f1tenth_costmap.ParaInflationLayer.is_raw_rosmessage)
...
inline void ParaInflationLayer::set_is_raw_rosmessage(bool value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_costmap.ParaInflationLayer.is_raw_rosmessage)
}
