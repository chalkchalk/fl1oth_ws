 ...
 ***************************************************************************/
#ifndef F1TENTH_PLANNING_GLOBAL_PLANNER_A_STAR_PLANNER_H
#define F1TENTH_PLANNING_GLOBAL_PLANNER_A_STAR_PLANNER_H
...
class AStarPlanner : public GlobalPlannerBase {
 ...
 public:
   ...
   */
  f1tenth_common::ErrorInfo Plan(const geometry_msgs::PoseStamped &start,
 ...
 private:
   ...
   * @return ErrorInfo which is OK if succeed
   */
  f1tenth_common::ErrorInfo SearchPath(const int &start_index,
   ...
   * @return ErrorInfo which is OK if succeed
   */
  f1tenth_common::ErrorInfo GetMoveCost(const int &current_index,
...
f1tenth_common::REGISTER_ALGORITHM(GlobalPlannerBase,
                                 "a_star_planner",
                                 AStarPlanner,
                                 std::shared_ptr<f1tenth_costmap::CostmapInterface>);

} //namespace f1tenth_global_planner

#endif // F1TENTH_PLANNING_GLOBAL_PLANNER_A_STAR_PLANNER_H
