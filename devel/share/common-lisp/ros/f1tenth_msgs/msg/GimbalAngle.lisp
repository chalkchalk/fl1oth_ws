...
(cl:defmethod cl:initialize-instance :after ((m <GimbalAngle>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'GimbalAngle)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenth_msgs-msg:<GimbalAngle> is deprecated: use f1tenth_msgs-msg:GimbalAngle instead.")))

(cl:ensure-generic-function 'yaw_mode-val :lambda-list '(m))
(cl:defmethod yaw_mode-val ((m <GimbalAngle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-msg:yaw_mode-val is deprecated.  Use f1tenth_msgs-msg:yaw_mode instead.")
  (yaw_mode m))

(cl:ensure-generic-function 'pitch_mode-val :lambda-list '(m))
(cl:defmethod pitch_mode-val ((m <GimbalAngle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-msg:pitch_mode-val is deprecated.  Use f1tenth_msgs-msg:pitch_mode instead.")
  (pitch_mode m))

(cl:ensure-generic-function 'yaw_angle-val :lambda-list '(m))
(cl:defmethod yaw_angle-val ((m <GimbalAngle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-msg:yaw_angle-val is deprecated.  Use f1tenth_msgs-msg:yaw_angle instead.")
  (yaw_angle m))

(cl:ensure-generic-function 'pitch_angle-val :lambda-list '(m))
(cl:defmethod pitch_angle-val ((m <GimbalAngle>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-msg:pitch_angle-val is deprecated.  Use f1tenth_msgs-msg:pitch_angle instead.")
  (pitch_angle m))
