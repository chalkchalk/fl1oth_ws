...
PROTOBUF_NAMESPACE_OPEN
template<> ::f1tenth_global_planner::AStarPlannerConfig* Arena::CreateMaybeMessage<::f1tenth_global_planner::AStarPlannerConfig>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
namespace f1tenth_global_planner {

// ===================================================================

class AStarPlannerConfig PROTOBUF_FINAL :
    public ::PROTOBUF_NAMESPACE_ID::Message /* @@protoc_insertion_point(class_definition:f1tenth_global_planner.AStarPlannerConfig) */ {
 public:
  ...
  inline AStarPlannerConfig* New() const final {
    return CreateMaybeMessage<AStarPlannerConfig>(nullptr);
  }

  AStarPlannerConfig* New(::PROTOBUF_NAMESPACE_ID::Arena* arena) const final {
  ...
  static ::PROTOBUF_NAMESPACE_ID::StringPiece FullMessageName() {
    return "f1tenth_global_planner.AStarPlannerConfig";
  }
  protected:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    ::PROTOBUF_NAMESPACE_ID::internal::AssignDescriptors(&::descriptor_table_a_5fstar_5fplanner_5fconfig_2eproto);
    return ::descriptor_table_a_5fstar_5fplanner_5fconfig_2eproto.file_level_metadata[kIndexInFileMessages];
  }
  ...
  ::PROTOBUF_NAMESPACE_ID::uint32 inaccessible_cost() const;
  void set_inaccessible_cost(::PROTOBUF_NAMESPACE_ID::uint32 value);
  private:
  ::PROTOBUF_NAMESPACE_ID::uint32 _internal_inaccessible_cost() const;
  void _internal_set_inaccessible_cost(::PROTOBUF_NAMESPACE_ID::uint32 value);
  public:
  ...
  // @@protoc_insertion_point(class_scope:f1tenth_global_planner.AStarPlannerConfig)
 private:
  class _Internal;
  ...
  ::PROTOBUF_NAMESPACE_ID::uint32 inaccessible_cost_;
...
inline ::PROTOBUF_NAMESPACE_ID::uint32 AStarPlannerConfig::_internal_inaccessible_cost() const {
  return inaccessible_cost_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 AStarPlannerConfig::inaccessible_cost() const {
  // @@protoc_insertion_point(field_get:f1tenth_global_planner.AStarPlannerConfig.inaccessible_cost)
  return _internal_inaccessible_cost();
}
inline void AStarPlannerConfig::_internal_set_inaccessible_cost(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _has_bits_[0] |= 0x00000002u;
  inaccessible_cost_ = value;
}
inline void AStarPlannerConfig::set_inaccessible_cost(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  _internal_set_inaccessible_cost(value);
  // @@protoc_insertion_point(field_set:f1tenth_global_planner.AStarPlannerConfig.inaccessible_cost)
}
...
inline float AStarPlannerConfig::heuristic_factor() const {
  // @@protoc_insertion_point(field_get:f1tenth_global_planner.AStarPlannerConfig.heuristic_factor)
...
inline void AStarPlannerConfig::set_heuristic_factor(float value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_global_planner.AStarPlannerConfig.heuristic_factor)
}
...
inline float AStarPlannerConfig::goal_search_tolerance() const {
  // @@protoc_insertion_point(field_get:f1tenth_global_planner.AStarPlannerConfig.goal_search_tolerance)
...
inline void AStarPlannerConfig::set_goal_search_tolerance(float value) {
  ...
  // @@protoc_insertion_point(field_set:f1tenth_global_planner.AStarPlannerConfig.goal_search_tolerance)
}
