...
(cl:defmethod cl:initialize-instance :after ((m <RobotShoot>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RobotShoot)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenrh_msgs-msg:<RobotShoot> is deprecated: use f1tenrh_msgs-msg:RobotShoot instead.")))

(cl:ensure-generic-function 'frequency-val :lambda-list '(m))
(cl:defmethod frequency-val ((m <RobotShoot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:frequency-val is deprecated.  Use f1tenrh_msgs-msg:frequency instead.")
  (frequency m))

(cl:ensure-generic-function 'speed-val :lambda-list '(m))
(cl:defmethod speed-val ((m <RobotShoot>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:speed-val is deprecated.  Use f1tenrh_msgs-msg:speed instead.")
  (speed m))
