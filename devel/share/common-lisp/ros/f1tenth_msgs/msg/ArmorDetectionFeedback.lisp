...
(cl:defmethod cl:initialize-instance :after ((m <ArmorDetectionFeedback>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'ArmorDetectionFeedback)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenth_msgs-msg:<ArmorDetectionFeedback> is deprecated: use f1tenth_msgs-msg:ArmorDetectionFeedback instead.")))

(cl:ensure-generic-function 'detected-val :lambda-list '(m))
(cl:defmethod detected-val ((m <ArmorDetectionFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-msg:detected-val is deprecated.  Use f1tenth_msgs-msg:detected instead.")
  (detected m))

(cl:ensure-generic-function 'error_code-val :lambda-list '(m))
(cl:defmethod error_code-val ((m <ArmorDetectionFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-msg:error_code-val is deprecated.  Use f1tenth_msgs-msg:error_code instead.")
  (error_code m))

(cl:ensure-generic-function 'error_msg-val :lambda-list '(m))
(cl:defmethod error_msg-val ((m <ArmorDetectionFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-msg:error_msg-val is deprecated.  Use f1tenth_msgs-msg:error_msg instead.")
  (error_msg m))

(cl:ensure-generic-function 'enemy_pos-val :lambda-list '(m))
(cl:defmethod enemy_pos-val ((m <ArmorDetectionFeedback>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenth_msgs-msg:enemy_pos-val is deprecated.  Use f1tenth_msgs-msg:enemy_pos instead.")
  (enemy_pos m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<ArmorDetectionFeedback>)))
  ...
  "f1tenth_msgs/ArmorDetectionFeedback")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'ArmorDetectionFeedback)))
  "Returns string type for a message object of type 'ArmorDetectionFeedback"
  "f1tenth_msgs/ArmorDetectionFeedback")
