...
"""autogenerated by genpy from f1tenth_msgs/ArmorDetectionActionResult.msg. Do not edit."""
import sys
...
class ArmorDetectionActionResult(genpy.Message):
  ...
  _type = "f1tenth_msgs/ArmorDetectionActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','f1tenth_msgs/ArmorDetectionResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.result is None:
        self.result = f1tenth_msgs.msg.ArmorDetectionResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = f1tenth_msgs.msg.ArmorDetectionResult()
