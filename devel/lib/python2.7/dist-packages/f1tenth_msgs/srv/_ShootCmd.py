...
"""autogenerated by genpy from f1tenth_msgs/ShootCmdRequest.msg. Do not edit."""
import sys
...
class ShootCmdRequest(genpy.Message):
  ...
  _type = "f1tenth_msgs/ShootCmdRequest"
...
def _get_struct_2B():
    ...
    return _struct_2B
# This Python file uses the following encoding: utf-8
"""autogenerated by genpy from f1tenth_msgs/ShootCmdResponse.msg. Do not edit."""
import sys
python3 = True if sys.hexversion > 0x03000000 else False
import genpy
import struct
...
class ShootCmdResponse(genpy.Message):
  ...
  _type = "f1tenth_msgs/ShootCmdResponse"
  _has_header = False #flag to mark the presence of a Header object
