...
(cl:defmethod cl:initialize-instance :after ((m <TwistAccel>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TwistAccel)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name f1tenrh_msgs-msg:<TwistAccel> is deprecated: use f1tenrh_msgs-msg:TwistAccel instead.")))

(cl:ensure-generic-function 'twist-val :lambda-list '(m))
(cl:defmethod twist-val ((m <TwistAccel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:twist-val is deprecated.  Use f1tenrh_msgs-msg:twist instead.")
  (twist m))

(cl:ensure-generic-function 'accel-val :lambda-list '(m))
(cl:defmethod accel-val ((m <TwistAccel>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader f1tenrh_msgs-msg:accel-val is deprecated.  Use f1tenrh_msgs-msg:accel instead.")
  (accel m))
